# Data loading based on https://github.com/autonomousvision/unimatch
import os
import numpy as np
...
class StereoDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if 'disp' in sample_path and sample_path['disp'] is not None:
            ...
            # for middlebury and eth3d dataset, invalid is denoted as inf
...
class FlyingThings3D(StereoDataset):
    def __init__(self,
                 data_dir='dataset/SceneFlow/FlyingThings3D',
                 mode='TRAIN',
        ...
        for left_name in left_files:
            ...
            if mode == 'TEST':
                # save filename
                sample['left_name'] = left_name.replace(data_dir + '/' + split + '/'  + mode + '/', '')
                sample['left_name'] = sample['left_name'].replace('/', '-')
                # print(sample['left_name'])
...
class Monkaa(StereoDataset):
    def __init__(self,
                 data_dir='dataset/SceneFlow/Monkaa',
                 split='frames_finalpass',
                 transform=None,
                 ):
...
class Driving(StereoDataset):
    def __init__(self,
                 data_dir='dataset/SceneFlow/Driving',
                 split='frames_finalpass',
                 transform=None,
                 ):
...
class KITTI15(StereoDataset):
    def __init__(self,
                 data_dir='dataset/KITTI/kitti2015',
                 mode='training',
                 transform=None,
                 save_filename=False,
                 ):
...
class KITTI12(StereoDataset):
    def __init__(self,
                 data_dir='dataset/KITTI/kitti2012',
                 mode='training',
                 transform=None,
                 ):
...
class DrivingStereo(StereoDataset):
    def __init__(self,
                 data_dir='dataset/DrivingStereo',
                 transform=None,
                 ):
...
class Middlebury20052006(StereoDataset):
    def __init__(self,
                 data_dir='../hy-tmp/Middlebury/2005',
                 transform=None,
                 save_filename=False,
                 ):
...
class Middlebury2014(StereoDataset):
    def __init__(self,
                 data_dir='../hy-tmp/Middlebury/2014',
                 transform=None,
                 save_filename=False,
...
class Middlebury2021(StereoDataset):
    def __init__(self,
                 data_dir='../hy-tmp/Middlebury/2021/data',
                 transform=None,
                 save_filename=False,
                 ):
...
class CARLA(StereoDataset):
    def __init__(self,
                 data_dir='dataset/HR-VS-Stereo/carla-highres/trainingF',
                 transform=None,
                 ):
...
class FallingThings(StereoDataset):
    def __init__(self,
                 data_dir='dataset/FallingThings',
                 transform=None,
                 ):
...
def build_dataset(args):
    if args.stage == 'sceneflow':
        ...
        train_dataset =  20*kitti15 + 10*kitti12
        ...
        # middlebury 2016: 210
        mb2006 = Middlebury20052006(data_dir='../hy-tmp/Middlebury/2006',
        ...
        train_dataset = 10 * mb2014 + 20 * mb2021 + 20 * mbeval3
        ...
        train_dataset = 5 * mb2014 + \
                        10 * mb2021 + 10 * mbeval3 + 10 * mb2014_half + 10 * mbeval3_half
