...
from .geometry import coords_grid_one, coords_grid, normalize_coords, generate_window_grid


def local_correlation_with_disp(feature0, feature1,
                                disp,
                                local_radius,
                                padding_mode='zeros',
                                dilation=1,
    ...
    if not isinstance(disp, float):
        sample_coords = sample_coords + disp.view(
